namespace Wasla_Backend.Controllers.Gym
{
    ...
    public class GymBookingController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetBookingsOfGym(string gymId, string lan = "en")
        {
            ...
            return Ok(ResponseHelper.Success(LocalizationKey.BookingsRetrievedSuccessfully, lan, data));
        }
        ...
        public async Task<IActionResult> GymCharts(string gymId, string lan = "en")
        {
            ...
            return Ok(ResponseHelper.Success(LocalizationKey.FetchChartSuccess, lan, charts));
        }
        ...
        public async Task<IActionResult> GetMembeers(int serviceId, string lan = "en")
        {
            ...
            return Ok(ResponseHelper.Success(LocalizationKey.FetchMembersSuccess, lan, data));
        }
        ...
        public async Task<IActionResult> ValidateQr(int bookingId, string lan = "en")
        {
            ...
            if (result.IsValid)
            {
                return Ok(ResponseHelper.Success(LocalizationKey.QrCodeValid, lan, result));
            }
            else
            {
                return Ok(ResponseHelper.Success(LocalizationKey.QrCodeInvalid, lan));
            }
        }
    }
}