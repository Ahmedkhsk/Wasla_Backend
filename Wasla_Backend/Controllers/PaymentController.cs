namespace Paymob_Integration_DotNet.Controllers
{
    ...
    public class PaymentController : ControllerBase
    {
        ...
        "source_data.pan", "source_data.sub_type", "source_data.type", "success"
            ...
            {
                return Content("<html><body><h1>Security Error ⚠️ Invalid HMAC</h1></body></html>", "text/html");
            }
            ...
            if (isSuccess)
            {
                return Content("<html><body><h1>Payment Successful ✅</h1></body></html>", "text/html");
            }

            return Content("<html><body><h1>Payment Failed ❌</h1></body></html>", "text/html");
        }
