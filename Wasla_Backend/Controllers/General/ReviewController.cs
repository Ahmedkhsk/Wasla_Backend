namespace Wasla_Backend.Controllers
{
    ...
    public class ReviewController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetReviewsByServiceProviderId(string serviceProviderId, string lan = "en")
        {
            ...
            return Ok(ResponseHelper.Success(LocalizationKey.GetReviewsSuccess, lan, reviews));
        }
        ...
        public async Task<IActionResult> DeleteReview(int reviewid, string lan = "en")
        {
            ...
            return Ok(ResponseHelper.Success(LocalizationKey.ReviewDeletedSuccessfully, lan));
        }
        ...
        public async Task<IActionResult> UpdateReview(UpdateReviewDto updateReviewDto, string lan = "en")
        {
            ...
            return Ok(ResponseHelper.Success(LocalizationKey.ReviewUpdatedSuccessfully, lan));
        }
        ...
        public IActionResult PredictToxicity(string text)
        {
            ...
            return Ok(ResponseHelper.Success(LocalizationKey.ToxicityPredictionSuccess, "en", new
            {
                isToxic = isBad,
                textProcessed = text
            }));
